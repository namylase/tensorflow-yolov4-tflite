...
flags.DEFINE_string('image_folder', './data/kite.jpg', 'path to input image')
...
def main(_argv):
    ...
    for process, image_name in enumerate(file_list):
      ...
      multiplier=np.array([original_image.shape[0],original_image.shape[1],original_image.shape[0],original_image.shape[1],10000]).T
